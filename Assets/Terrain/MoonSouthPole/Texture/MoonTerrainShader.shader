...
Shader "Custom/Moon Terrain Shader"
{
    Properties
    {
        _Color ("Multiply Color", Color) = (1,1,1,1)
        _AerialTex ("Aerial Overlays texture (RGB)", 2D) = "black" {}
        _AerialGlow ("Aerial Glow", Range(0,3)) = 1.0
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 aerial = tex2D (_AerialTex, uv);
